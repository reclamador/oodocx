...
def remove_all(doc, search, result_type='text'):
    """
    ...
    :param result_type: the type of element to delete. Default just the text
    found
    :return: None
    """
    ...
    while doc.search(search) is not None:
        paragraph = doc.search(search, result_type=result_type)
        remove(paragraph)
